                    ...
                    <div class="col-lg-4">
                        <div class="card card-inverse card-primary">
                            ...
                            <div class="card-block">
                                <center><img src="img/lecture-1.png" class="img-avatar" width="300px"></center>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-default">
                                ...
                                <p style="padding-right:50px;padding-left:50px;" class=form-control>
                                    <?php 
                                        ...
                                        $select=mysqli_query($mysqli,"SELECT teacherid FROM teacherlist WHERE teachername='$name'");
                                        $select=mysqli_fetch_array($select);
                                        echo $select[0];
                                    ?>
                                </p>
                                <p style="padding-right:50px;padding-left:50px;" class=form-control>
                                    Email: sharon_cuneta@outlook.com
                                </p>
                                <p style="padding-right:50px;padding-left:50px;" class=form-control>
                                    Educational Attainment: Doctorate
                                </p>
                                </div>
                            </div>   
                    </div>
