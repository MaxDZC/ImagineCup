                ...
                <div class="row">
                   <div class="col-md-6">
                       <div class="card">
                           ...
                           <div class="card-block">
                               <p>
                                   <h5>Data Structures & Algorithms in Java</h5>
                               </p>
                               <p>
                                   <h6><em>By Goodrich, Tamassia, Goldwasser</em></h6>
                               </p>
                               <p>
                                   <i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i>+5 Stars
                               </p>
                               <p>
                                   <form action="pdf/Data Structures and Algorithms in Java, 6th Edition, 2014.pdf">
                                   <button type="submit" class="btn btn-danger"><i class="fa fa-dot-circle-o"></i>Download</button>
                                   </form>
                               </p>
                               <img src="img/datastruct.png" width="480px"/>
                   ...
                   <div class="col-md-6">
                    <div class="card">
                       ...
                       <div class="card-block">
                           <p>
                               <em>Data Structures and Algorithms in Java</em> provides an introduction to data structures and algorithms, including their design, analysis and implementation...
                           </p>
                       </div>
                   </div></div>
                </div>
